    ...
    ProjectProfileComponent.prototype.ngOnInit = function () {
        ...
        this._homeService.get4id().subscribe(function (_data) {
            ...
            if (_this.currentuid) {
                ...
                _this.recommandp = new Array();
                if (_data.profile !== -1) {
                    _this.hasreco = true;
                    _this._projectService.getRecommendedProject(null, _data.profile) /////////////// make this equal to profileid;
...
var TeamService = (function () {
    ...
    TeamService.prototype.getRealTeams = function (tid) {
...
var UserEditComponent = (function () {
    ...
    UserEditComponent.prototype.save_edit = function () {
        ...
        this._userService.editRealProfile(this.user.uid, this.user.about, this.interested_areas).subscribe(function (_data) {
...
var UserNewComponent = (function () {
    ...
    UserNewComponent.prototype.save = function () {
        ...
        this._userService.postRealProfile(this.profile_form.user_id, this.profile_form.about, this.profile_form.related_areas).subscribe(function (_data) {
...
var UserService = (function () {
    ...
    UserService.prototype.postRealProfile = function (user_id, about, related_areas) {
        var data = { "user_id": user_id, "about": about, "related_areas": related_areas };
    ...
    UserService.prototype.editRealProfile = function (user_profile_id, about, related_areas) {
        var data = { "user_profile_id": user_profile_id, "about": about, "related_areas": related_areas };
