...
/* unused harmony export httpOptions */
...
var ProjectDetailComponent = (function () {
    function ProjectDetailComponent(_route, _userService, _teamService, _projectService, _homeService, _router) {
        ...
        this._router = _router;
        this.add_teamid = "";
        this.has_profile = false;
        this.match_pid = false;
    }
    ...
    ProjectDetailComponent.prototype.add_new_team = function () {
        var new_team = {
            team_id: this.add_teamid,
            project_id: this.project.pid
        };
        // console.log("add a team", new_team);
        this._teamService.joinProject(new_team).subscribe(function (__data) {
            swal({
                title: "Good job!",
...
var TeamEditComponent = (function () {
    function TeamEditComponent(_route, _home, _teamService, _projectService, _router) {
        this._route = _route;
        this._home = _home;
        this._teamService = _teamService;
        this._projectService = _projectService;
            ...
            _this._projectService.getArea()
                ...
                for (var x = 0; x < _area.length; x++) {
                    ...
                    for (var y = 0; y < _this.interested_areas.length; y++) {
                        if (_this.team.areas[x].tag_name === _this.interested_areas[y].tag_name) {
    ...
    TeamEditComponent.prototype.save = function () {
        ...
        this._teamService.editRealTeam(this.team.pk, this.team.name, this.team.magictoken, this.team.email, this.team.cloud, this.team.about, this.team.areas).subscribe(function (__data) {
            console.log("ok", __data);
            swal({
                title: "Your team has been edited successfully!",
                type: "success"
            });
            _this._router.navigate(['/teams/' + __data.team_id]);
        }, function (_err) {
            swal({
                title: "Error!",
                text: _err,
...
var TeamService = (function () {
    ...
    TeamService.prototype.getTeamforUser = function (tid) {
        return this._http.get(this.url + this.rest + tid + "/", this.httpOptions())
    ...
    TeamService.prototype.editRealTeam = function (team_id, name, magictoken, email, cloud, about, interested_areas) {
    ...
    TeamService.prototype.joinProject = function (__data) {
...
function Is_same(Object1, Object2) {
                ...
                _this._teamService.getTeamforUser(_user.tid)
                    ...
                    _this._teamService.getTeamforUser(_user.tid)
                        ...
                        _this._homeService.get4id() //test with team,combine to one later
                            ...
                            if (_info.user) {
                                _this._projectService.getUserCreatedProject(_info.user)
                                    .subscribe(function (_projects) {
